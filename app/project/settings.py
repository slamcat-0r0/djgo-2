...
SECRET_KEY = 'django-insecure-2y%$6ly5z22@9d-8j=-%3xex1(e4)-eu-x2r-u+w$^6+ha%y3j'
...
# Serving static files for nginx
STATIC_URL = "/static/"
...
# Custom settings ----------------------------------------------------->
CSRF_TRUSTED_ORIGINS=os.environ.get("DJGO_CSRF_TRUSTED_ORIGINS").split(",")
